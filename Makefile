...
SRC = $(SRCDIR)/libabc.c $(SRCDIR)/dabccdfs.c $(SRCDIR)/dmlabccdfs2.c $(SRCDIR)/dabcrs.c $(SRCDIR)/dabcmcmc.c $(SRCDIR)/dabcpcr.c $(SRCDIR)/dabcrjs.c $(SRCDIR)/dmlabcnls2.c $(SRCDIR)/dabcns.c $(SRCDIR)/dmcint.c $(SRCDIR)/dmcintd.c $(SRCDIR)/copyDataset.c $(SRCDIR)/monotone.c $(SRCDIR)/cdf2pmf.c $(SRCDIR)/dmlabcnlps.c
OBJS = $(SRC:.c=.o)
EXEOBJS=$(EXESRC:.c=.o)
EXE = $(EXESRC:.c=)
