...
/* Example of ABC-MCMC samples for toy problem from Sisson et al.*/
...
int main(int argc, char ** argv)
{
    ...
    start_t = clock();
    dabcmcmc(abc_p,mcmc_p,&data,theta,NULL);
    end_t = clock();
    time = ((double)(end_t - start_t))/((double)CLOCKS_PER_SEC);
    /*write output*/
    fprintf(stdout,"\"Interations\",\"theta\",\"SEC\",\"NACC\",\"NSIMS\"\n");
