...
main(int argc, char** argv)
{
    ...
    else
    {
        ...
        abc_p.eps = (double)atof(argv[3 + numFiles]);
        ...
        {
            abc_p.support[k] = (double)atof(argv[4+numFiles+k]);
        }
        abc_p.sim = NULL;
        abc_p.rho = &rho;
        abc_p.p = &prior;
       ...
       // mcmc_p.theta0[0] = 4404.9;
        ...
        {
            mcmc_p.theta0[k] = (double)atof(argv[4 + numFiles + abc_p.k*2 + k]);
        }*/
        mcmc_p.q = &kernel;
        mcmc_p.qd = &kernelPDF;
    }
    ...
    datasets = (Dataset **)data_collection.fields[0].data_array;
    {
        ...
        fprintf(stderr,"ABC Information:\n");
    ...
    dabcmcmc(abc_p,mcmc_p,&data_collection,theta,d);
    end_t = clock();
